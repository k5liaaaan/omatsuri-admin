...
const Dashboard: React.FC = () => {
  ...
  const handleTestFestivalClick = () => {
    console.log('テストページボタンがクリックされました');
    navigate('/festival/test');
  };

  const handleSimpleFestivalClick = () => {
    console.log('シンプルテストページボタンがクリックされました');
    navigate('/festival/simple');
  };
        ...
        <div className="dashboard-content">
          ...
          <div className="feature-section">
            <h3 className="feature-section-title">一般機能</h3>
                ...
                <div className="feature-card" onClick={handleTestFestivalClick} style={{ cursor: 'pointer' }}>
                  <div className="feature-icon">
                    <svg width="24" height="24" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="feature-card" onClick={handleSimpleFestivalClick} style={{ cursor: 'pointer' }}>
                  <div className="feature-icon">
                    <svg width="24" height="24" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                    </svg>
